...
@Component({
  ...
  >
    <div class="overlay" [hidden]="file">
      ...
      <span>
        <!-- i18n: @@MINDS__BANNER__ADD_NEW_BANNER -->Click here to add a new banner<br>
    ...
    <div class="save-bar" [hidden]="!file">
      ...
      <span class="minds-button-edit cancel-button" (click)="cancel()">
        <button i18n="@@MINDS__BANNER__CANCEL">Cancel</button>
      </span>
      <span class="minds-button-edit save-button" (click)="done()">
        <button i18n="@@MINDS__BANNER__SAVE">Save</button>
      </span>
    </div>
